<?php
    ...
    function load_page_styles() {
        ...
        wp_register_style('lgo-styles', get_template_directory_uri() . '/assets/css/styles.min.css?' . date('l jS \of F Y h:i:s A'), array(), '1.0', 'all');
    ...
    function load_page_scripts() {
        ...
        wp_register_script('lgo-scripts', get_template_directory_uri() . '/assets/js/scripts.js?' . date('l jS \of F Y h:i:s A'), array('jquery'), '1.0.0', true); // Custom scripts
        wp_enqueue_script('lgo-scripts');
