...
function outputNewsWdgTwoWide() {

	if( have_rows('squares', 'option') ):
		?>
		<div class="container-fluid" id="news_wdg_two_wide">
		<?php
	    while ( have_rows('squares', 'option') ) : the_row();
	        ...
	        <a href="<?php echo $link['url']; ?>">
	        	<div class="wdg-container square dimmed" style="background-image: url(<?php echo $feat_img['url']; ?>);">
